...
OptimizationParams=dict(
    ...
    # opacity_threshold_coarse = 0.01,#0.005
    # opacity_threshold_fine_init = 0.0005,#0.005
    # opacity_threshold_fine_after = 0.0005,#0.005
    # batch_size=2,
    # add_point=False,
    # uncertainty_weight = 1e-6,#不确定性loss的系数
    # coarse_iterations = 8000,

    # prune_threshold = 40000,
    grow_threshold = 600_000,
    attn_scale = 50,
    uncertainty_weight = 0.005,
    # coarse_densify_threshold = 60_000,
    # fine_densify_threshold = 750_000,
