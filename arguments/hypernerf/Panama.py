...
OptimizationParams=dict(
    ...
    densify_grad_threshold_coarse = 0.000002,#0.0002
    densify_grad_threshold_fine_init =0.000001,
    densify_grad_threshold_after = 0.00002,#0.0002
    pruning_from_iter = 500,#500
    pruning_interval = 100,
    opacity_threshold_coarse = 0.008,#0.005
    ...
    grow_threshold = 500_000,
    coarse_densify_threshold = 500_000,
    fine_densify_threshold = 900_000,
