...
OptimizationParams=dict(
    ...
    densify_grad_threshold_coarse = 0.000007,#0.0002
    densify_grad_threshold_fine_init = 0.000002,
    densify_grad_threshold_after = 0.00001,#0.0002
    ...
    grow_threshold = 1100_000,
    coarse_densify_threshold = 800_000,
    fine_densify_threshold = 1100_000,
