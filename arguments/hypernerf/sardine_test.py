...
OptimizationParams=dict(
    ...
    densify_grad_threshold_coarse = 0.00005,#0.0002
    densify_grad_threshold_fine_init = 0.00005,
    densify_grad_threshold_after = 0.0004,#0.0002
    ...
    grow_threshold = 360_000,
    coarse_densify_threshold = 360_000,
    fine_densify_threshold = 360_000,
