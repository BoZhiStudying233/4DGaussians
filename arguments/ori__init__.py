...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.deformation_lr_final = 0.000016#0.000016
        ...
        self.medium_lr_delay_mult = 0.01#0.01


        self.feature_lr_init = 0.0025#0.0025
        self.feature_lr_final = 0.0025#0.00025
        self.feature_lr_delay_mult = 0.0

        self.opacity_lr_init = 0.05#0.05
        self.opacity_lr_final = 0.05#0.005
        self.opacity_lr_delay_mult = 0.0

        self.scaling_lr_init = 0.005#0.005
        self.scaling_lr_final = 0.005
        self.scaling_lr_delay_mult = 0.0

        self.rotation_lr_init = 0.001#0.001
        self.rotation_lr_final = 0.001
        self.rotation_lr_delay_mult = 0.0
    ...
    # def get_densify_threshold(self, stage):
    #     if stage == "coarse":
    #         return self.coarse_densify_threshold
    #     elif stage == "fine":
    #         return self.fine_densify_threshold
    #     else:
